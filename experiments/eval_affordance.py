...
flags.DEFINE_string('model_path', '/home/fanyang/github/ptp_baseline/data_ckpt/affordance_final.pt', 'the path to load the affordance')
...
def train_eval(
    ...
    affordance = torch.load(model_path)
    ...
    for epoch in range(num_epochs):
        ...
        trainer.viz_epoch(epoch, test_loader, num_test_batches_per_epoch)
